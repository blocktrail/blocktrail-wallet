(function() {
    ...
    function LaunchCtrl($window, $filter, $q, $rootScope, $state, $log, $ionicHistory, $ionicSideMenuDelegate,
                        launchService, CONFIG, storageService, localSettingsService, bitcoinLinkService) {
